...
type EncryptedPayload struct {
	...
	GroupId       string                 `protobuf:"bytes,10,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"` // empty for 1:1 messages, group UUID for group messages
...
const file_proto_message_proto_rawDesc = "" +
	"\n" +
	"\x13proto/message.proto\x12\x02pb\"\xc6\x02\n" +
